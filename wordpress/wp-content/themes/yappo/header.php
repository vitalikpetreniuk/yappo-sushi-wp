                                                ...
                                                <li>
                                                    <a href="<?= $cityLink ?>"
                                                       ...
                                                       data-address="<?= $city->slug . '/' . $index ?>">
                                                        ...
                                                        <span class="adress"
                                                              itemprop="streetAddress"><?= $item['item']['name'] ?></span>
                                                    </a>
                                                </li>
                                            <?php }
                                        }
                            ...
                            <div class="time-wrap d-flex align-items-center">
                                ...
                                <div itemscope itemtype="http://schema.org/LocalBusiness">
                                    ...
                                    <time itemprop="openingHours"
                                          datetime="<?php the_field('working_hours', 'option') ?>">
                        ...
                        <div class="col-lg-6 col-md-9">
                            <div class="social-wrap d-flex justify-content-between">
                                <?php if (get_field('instagram_link', 'option')) : ?>
                                    <a href="<?php the_field('instagram_link', 'option') ?>" rel="nofollow"
                                       target="_blank">
                                ...
                                <?php if (get_field('facebook_link', 'option')) : ?>
                                    <a href="<?php the_field('facebook_link', 'option') ?>" rel="nofollow"
                                       target="_blank">
                                ...
                                <?php if (get_field('telegram_link', 'option')) : ?>
                                    <a href="<?php the_field('telegram_link', 'option') ?>" rel="nofollow"
                                       target="_blank">
                                    ...
                                    <div class="cotegory_img">
                                        <?php if (get_field('image', $term)) : ?>
                                            <img class="image-category"
                                                 ...
                                                 alt="Go to <?= $term->name ?>" loading="lazy">
                                        <?php endif; ?>
