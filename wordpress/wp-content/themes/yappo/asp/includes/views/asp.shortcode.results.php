...
?>
<div id='__original__ajaxsearchprores<?php echo $id; ?>'
     class='asp_w asp_w1 asp_r asp_r_<?php echo $real_id; ?> asp_r_<?php echo $id; ?> <?php echo $style['resultstype']; ?> ajaxsearchpro wpdreams_asp_sc wpdreams_asp_sc-<?php echo $real_id; ?>'
	...
	<?php if ( $style['results_top_box'] == 1 && $style['results_top_box_text'] != '' ): ?>
		<div class="asp_results_top" style="display:none;">
			<div
				class="asp_rt_phrase"><?php echo stripslashes( asp_icl_t( "Results header information box text, whith search phrase" . " ($id)", $style['results_top_box_text'] ) ); ?></div>
			<div
				class="asp_rt_nophrase"><?php echo stripslashes( asp_icl_t( "Results header information box text, without search phrase" . " ($id)", $style['results_top_box_text_nophrase'] ) ); ?></div>
		</div>
	<?php endif; ?>
	...
	<?php if ( $style['showmoreresults'] == 1 ): ?>
		...
		<div class="asp_showmore_container">
			<p class='showmore'>
				<a class='asp_showmore'
				   href="<?php echo esc_url( get_site_url() ); ?>"><?php echo asp_icl_t( "More results text" . " ($real_id)", $style['showmoreresultstext'] ) . " <span></span>"; ?></a>
			</p>
