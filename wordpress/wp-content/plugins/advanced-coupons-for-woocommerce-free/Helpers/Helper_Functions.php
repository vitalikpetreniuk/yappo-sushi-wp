...
class Helper_Functions {
    ...
    public function get_price( $product ) {
        ...
        $ignore_always_use_regular_price = isset( $product->get_price_ignore_always_use_regular_price ) ? true : false;
        $always_regular_price_option     = get_option( Plugin_Constants::ALWAYS_USE_REGULAR_PRICE );
        $always_regular_price_options    = array( 'yes', 'all_valid' );
        if ( in_array( $always_regular_price_option, $always_regular_price_options, true ) && ! $ignore_always_use_regular_price ) {
