...
use ACFWF\Models\REST_API\API_Emails;
...
class ACFWF extends Abstract_Main_Plugin_Class { // phpcs:ignore
    ...
    private function _initialize_plugin_components() {
        ...
        // boostrap args.
        $initiables     = array( $cart_conditions, $admin_app, $edit_coupon, $bogo_admin, $notices, $upsell, $admin_notes, $help_links, $editor_blocks, $store_credits_admin, $store_credits_checkout, $store_credits_myaccount, $usage, $emails, $plugin_installer );
        ...
        API_Emails::get_instance( $this, $this->Plugin_Constants, $this->Helper_Functions );
