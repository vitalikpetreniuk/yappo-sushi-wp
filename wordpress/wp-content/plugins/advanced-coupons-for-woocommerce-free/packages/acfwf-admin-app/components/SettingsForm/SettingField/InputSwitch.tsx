...
import { Input, Switch, Select, Radio, Space, message, TimePicker } from "antd";
...
const InputSwitch = (props: IProps) => {
  ...
  const { id, title, type, placeholder, default: defaultValue, suffix, format } = field;
  ...
  if (["text", "url", "number", "permalink", "customurl"].indexOf(type) > -1) {
