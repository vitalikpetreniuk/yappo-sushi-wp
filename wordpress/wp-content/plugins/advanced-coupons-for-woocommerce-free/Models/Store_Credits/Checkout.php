...
class Checkout implements Model_Interface, Initializable_Interface {
    ...
    /**
     * Property that holds the single main instance of Store_Credits_Checkout.
     *
     * @since 4.0
     * @access private
     * @var Admin
    ...
    public function display_store_credits_checkout_redeem_form() {
        ...
        $session_name    = $is_apply_coupon ? Plugin_Constants::STORE_CREDITS_COUPON_SESSION : Plugin_Constants::STORE_CREDITS_SESSION;
    ...
    public function display_store_credits_discount_row() {
        ...
        if ( 'coupon' === $store_credit_apply_type_option ) {
            $this->_clear_store_credit_session();
            return;
        }
     ...
     * @access private
     */
    private function _clear_store_credit_session() {
        \WC()->session->set( Plugin_Constants::STORE_CREDITS_SESSION, null );
