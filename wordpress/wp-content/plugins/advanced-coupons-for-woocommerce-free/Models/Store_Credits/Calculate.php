...
class Calculate implements Model_Interface, Deactivatable_Interface {
    ...
    public function validate_user_last_active( $user_id ) {
        ...
        $expire_timestamp = $datetime->getTimestamp() - ( $this->get_store_credit_expiry_days() * DAY_IN_SECONDS );
    ...
    public function maybe_check_on_all_users_balance_expiry() {
        ...
        $expire_timestamp = time() - ( $this->get_store_credit_expiry_days() * DAY_IN_SECONDS );
    ...
    public function should_store_credits_expire() {
        return apply_filters( 'acfw_should_store_credits_expire', false );
    }
