    ...
    public function render_acfw_social_links_option_field( $value ) {
        ...
        <tr valign="top" class="<?php echo esc_attr( $value['id'] ) . '-row'; ?>">
            ...
            <td>
                <ul style="margin:0">
                    <li>
                        <a href="https://facebook.com/advancedcoupons/"><?php esc_html_e( 'Like us on Facebook', 'advanced-coupons-for-woocommerce-free' ); ?></a>
                    ...
                    <li>
                        <a href="https://twitter.com/advancedcoupons"><?php esc_html_e( 'Follow us on Twitter', 'advanced-coupons-for-woocommerce-free' ); ?></a>
                    ...
                    <li>
                        <a href="https://www.linkedin.com/company/rymera-web-co/"><?php esc_html_e( 'Follow us on Linkedin', 'advanced-coupons-for-woocommerce-free' ); ?></a>
                    </li>
                </ul>
            </td>
        </tr>
