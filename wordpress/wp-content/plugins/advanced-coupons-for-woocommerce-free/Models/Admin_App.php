...
class Admin_App implements Model_Interface, Initializable_Interface, Deactivatable_Interface {
    ...
    public function register_react_scripts( $screen, $post_type ) {
        ...
        wp_enqueue_style( 'acfwf-admin-app', $this->_constants->DIST_ROOT_URL() . 'acfwf-admin-app.css', array(), Plugin_Constants::VERSION, 'all' );
        wp_enqueue_script( 'acfwf-admin-app', $this->_constants->DIST_ROOT_URL() . 'acfwf-admin-app.js', array( 'wp-api' ), Plugin_Constants::VERSION, true );
