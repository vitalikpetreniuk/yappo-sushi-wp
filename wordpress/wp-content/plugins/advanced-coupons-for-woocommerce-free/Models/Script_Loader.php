...
class Script_Loader implements Model_Interface {
    ...
    private function _register_backend_scripts() {
        $acfw_backend_styles = apply_filters(
            ...
            array(
                ...
                'acfw-edit-advanced-coupon' => array(
                    'src'   => $this->_constants->DIST_ROOT_URL() . 'acfwf-edit-advanced-coupon.css',
                ...
                // ACFW Notices.
                'acfw-notices'              => array(
                    'src'   => $this->_constants->DIST_ROOT_URL() . 'acfwf-notices.css',
                    'deps'  => array(),
                    'ver'   => Plugin_Constants::VERSION,
                    'media' => 'all',
                ),
        ...
        $acfw_backend_scripts = apply_filters(
            ...
            array(
                ...
                // ACFW admin.
                'acfw-admin'                => array(
                    'src'    => $this->_constants->DIST_ROOT_URL() . 'acfwf-admin.js',
                    'deps'   => array( 'jquery' ),
                    'ver'    => Plugin_Constants::VERSION,
                    'footer' => true,
                ),
                ...
                'acfw-edit-advanced-coupon' => array(
                    'src'    => $this->_constants->DIST_ROOT_URL() . 'acfwf-edit-advanced-coupon.js',
                ...
                // ACFW Notices.
                'acfw-notices'              => array(
                    'src'    => $this->_constants->DIST_ROOT_URL() . 'acfwf-notices.js',
                    'deps'   => array( 'jquery' ),
                    'ver'    => Plugin_Constants::VERSION,
                    'footer' => true,
                ),
                ...
                'acfw-edit-order'           => array(
                    'src'    => $this->_constants->DIST_ROOT_URL() . 'acfwf-edit-order.js',
                    'deps'   => array( 'jquery' ),
                    'ver'    => Plugin_Constants::VERSION,
                    'footer' => true,
                ),
    ...
    public function load_frontend_scripts() {
        ...
        if ( is_checkout() ) {
            ...
            wp_enqueue_style( 'acfwf-checkout', $this->_constants->DIST_ROOT_URL() . 'acfwf-checkout.css', array( 'jquery-webui-popover' ), Plugin_Constants::VERSION, 'all' );
            wp_enqueue_script( 'acfwf-checkout', $this->_constants->DIST_ROOT_URL() . 'acfwf-checkout.js', array( 'jquery', 'jquery-webui-popover' ), Plugin_Constants::VERSION, true );
            wp_localize_script(
                'acfwf-checkout',
                'acfwfCheckout',
                array(
        ...
        if ( $is_store_credits_endpoint && is_account_page() && ! is_admin() ) {
            wp_enqueue_style( 'acfwf-store-credits-frontend', $this->_constants->DIST_ROOT_URL() . 'acfwf-store-credits-frontend.css', array(), Plugin_Constants::VERSION, 'all' );
            wp_enqueue_script( 'acfw-axios', $this->_constants->JS_ROOT_URL() . '/lib/axios/axios.min.js', array(), Plugin_Constants::VERSION, true );
            wp_enqueue_script( 'acfwf-store-credits-frontend', $this->_constants->DIST_ROOT_URL() . 'acfwf-store-credits-frontend.js', array( 'wp-api', 'acfw-axios' ), Plugin_Constants::VERSION, true );
            wp_localize_script(
    ...
    public function load_gutenberg_editor_scripts() {
        $edit_block_assets = include $this->_constants->DIST_ROOT_PATH() . 'acfwf-blocks.asset.php';

        wp_enqueue_style(
            'acfwf-blocks-edit',
            $this->_constants->DIST_ROOT_URL() . 'acfwf-blocks.css',
            array(),
        ...
        wp_enqueue_script(
            'acfwf-blocks-edit',
            $this->_constants->DIST_ROOT_URL() . 'acfwf-blocks.js',
