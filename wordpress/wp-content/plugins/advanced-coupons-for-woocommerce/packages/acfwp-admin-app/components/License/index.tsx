                ...
                <div className="license-form">
                    { showForm ? (
                        <Fragment>
                            ...
                            >
                                <Form.Item className="license-form-item" label={ formlabels.license_key } name="key">
                                    <Input type="password" autocomplete="off" />
                                </Form.Item>
                                <Form.Item className="license-form-item" label={ formlabels.email } name="email">
                                    <Input type="email" autocomplete="off" />
                                </Form.Item>
                                <Form.Item className={`license-form-item form-action ${license.is_active == 'yes' ? 'grayed' : ''}`}>
