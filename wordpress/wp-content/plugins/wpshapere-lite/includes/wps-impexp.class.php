...
if (!class_exists('WPS_IMP_EXP')) {
    ...
    class WPS_IMP_EXP extends WPSHAPERE
    {
        ...
        {
            $this->aof_options = parent::get_wps_option_data(WPSHAPERE_LITE_OPTIONS_SLUG);
...
<?php
        ...
        function wps_settings_action() {
            if(isset($_POST['wps_import_settings_field']) ) {
                ...
                if(empty($import_data) || !is_serialized($import_data)) {
                    ...
                    parent::updateOption(WPSHAPERE_LITE_OPTIONS_SLUG, $data);
        ...
        function wps_get_settings() {
           $saved_data = parent::get_wps_option_data(WPSHAPERE_LITE_OPTIONS_SLUG);
           if(!empty($saved_data)) {
