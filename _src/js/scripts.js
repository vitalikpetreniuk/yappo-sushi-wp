...
// custom scripts
    ...
    $('.form-search-btn').on('click', function () {
        ...
        if ($('.modal-search').hasClass('modal-search-active')) {
            ...
            $('.header-center').addClass('header-center-scroll');
            $('#ajaxsearchprores1_1').css('display', 'block');
            ...
            $('#ajaxsearchprores1_1').css('display', 'none');
        }
    })
    ...
    if ($(".swiper").length) {
        const banner_slider = new Swiper(".banner-slider", {
            ...
            speed: 1e3,
            autoplay: {delay: 5e3, stopOnLastSlide: !0, disableOnInteraction: !1},
            breakpoints: {
                425: {},
                550: {spaceBetween: 100, slidesPerView: 1.4},
                768: {spaceBetween: 150, slidesPerView: 1.6},
                1024: {spaceBetween: 250, slidesPerView: 1.8},
                1700: {spaceBetween: 400, slidesPerView: 2}
            },
            on: {
                init: function () {
                    $('.banner-slider').removeClass('banner-slider_preview');
                },
            },
        })
    }
